...
const isAuthor = computed(function () {
  return (auth.user?._id || auth.user?.id) === props.test.author._id;
});

const coverImage = computed(function () {
  ...
  <div class="test-card">
    <div class="test-image-wrapper">
      ...
      <div v-if="isAuthor" class="test-actions-overlay">
        <button class="btn-icon-circle" title="Редактировать" @click="emit('edit', test._id)">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
          </svg>
        </button>
        <button class="btn-icon-circle btn-icon-danger" title="Удалить" @click="handleDelete">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
